...
7	Posare il calcestruzzo con autopompa, evitando l'utilizzo diretto della canala o il sollevamento in quota con l'ausilio 
	della benna.
...
8	E' vietata qualsiasi aggiunta di acqua nelle autobetoniere che potrebbe modificare lo slump previsto a progetto e compromettere la resistenza finale e la tenuta idraulica.
9	Ridurre al minimo l'altezza di caduta libera del calcestruzzo fresco per evitare la separazione dei suoi componenti. Utilizzare nei muri idonei tubi getto e/o prolunghe gommate.
10	Per la platea, procedere senza interruzioni, con il getto di calcestruzzo in continuità, per strisce "finite" nel rispetto delle indicazioni del progetto di impermeabilizzazione del Sistema PENETRON® senza riprese di getto. Qualora si verificassero sbavature o fuoriuscita di calcestruzzo dai casseri o reti fermagetto, si dovrà provvedere alla demolizione dei volumi di calcestruzzo eccedenti, opportuna pulizia dei “presidi complementari” del Sistema e dei ferri di armatura.
11	E' necessaria l'adozione di appositi accorgimenti per la corretta maturazione dei getti di platea con bagnatura degli stessi a saturazione con acqua per i primi 3 giorni, oppure, l’utilizzo di anti-evaporanti.
12	Gli accessori complementari di ripresa di getto e di fessurazione programmata del Sistema PENETRON®, sia di platea che di parete, dovranno essere adeguatamente fissati e sostenuti alle armature specifiche.
13	Per eventuali getti contro terra e contro palificata/diaframmi prevedere la posa di apposito strato separatore quale tessuto TNT da 400 g/mq., oppure, utilizzare teli di nylon per il confinamento di materiale estraneo al getto nelle fasi di realizzazione e pompaggio.
14	La rimozione delle casserature dei muri dovrà avvenire come “minimo” dopo 72 ore di maturazione dei getti e comunque in ottemperanza ai processi di maturazione nella Normativa vigente in cui le tempistiche di disarmo dipendono dalla temperatura e dall'umidità ambientale, dal tipo e quantità di cemento e da eventuali additivi impiegati. Il riferimento é la norma UNI EN 70:2010, le Linee Guida per la messa in opera del calcestruzzo strutturale ed alle Linee Guida per la valutazione delle caratteristiche del calcestruzzo in opera elaborate e pubblicate dal Servizio Tecnico Centrale del Consiglio Superiore dei Lavori Pubblici, la UNI EN 206 e la UNI 11104.
        </div>
      </div>
    </section>
    ...
    <section class="notes-page">
      <div class="notes-content">
        <h2 class="notes-title">Note</h2>
        <div class="notes-text">15	Per i corpi inglobati nella matrice in cls, quali in particolare le tubazioni in genere e di scarico acqua meteorica, devono essere fissati sulle armature superiori, sospesi con apposite barre e si prescrive uno strato minimo di 20 cm di calcestruzzo fra essi e il magrone.
16	Per i corpi passanti la matrice in calcestruzzo, di platea e dei muri di contenimento, quali in particolare le tubazioni in genere, scarichi e impianti, saranno dotati di appositi presidi di tenuta idraulica come da specifica di dettaglio del Sistema PENETRON®.
17	Per le chiamate dei getti orizzontali e verticali utilizzando elementi prefabbricati tipo STABOX si prescrive uno spessore dietro la cassetta di almeno 20 cm e l’inserimento di presidi in gomma idroespansiva nei ferri di ripresa. 
18	Qualsiasi modifica della posizione delle riprese di getto e di fessurazione programmata orizzontali e verticali in fase di realizzazione dell'opera, rispetto alle indicazioni del progetto di impermeabilizzazione del Sistema PENETRON®, dovrà essere autorizzata dal personale tecnico di MD Italia srl.
19	Le “non conformità esecutive” dei getti in calcestruzzo come: segregazione al piede, nidi di ghiaia, riprese di getto naturali (per tempistiche allungate o scarsa vibratura), mancanze della matrice e fessurazioni di vario genere: da ritiro igrometrico, indotte da cambio di sezione ed elementi passanti, saranno oggetto di apposito ciclo di ripristino previsto dal Sistema PENETRON®.
20	Il reinterro delle murature perimetrali dovrà avvenire generalmente a completa maturazione del cls, indicativamente a 28gg (o a avvenuta verifica, da parte della DL, della resistenza a compressione minima del cls) e comunque dopo che il personale di MD ITALIA s.r.l. abbia verificato la corretta chiusura dei fori dei tiranti dei casseri, delle fessurazioni programmate e il ripristino di eventuali “non conformità esecutive” della matrice in calcestruzzo. 
21	Il disarmo dei sistemi di sostegno provvisionale dello scavo (tiranti-puntoni) dovrà avvenire generalmente a completa maturazione del cls, indicativamente a 28gg (o a avvenuta verifica, da parte della DL, della resistenza a compressione minime del cls) e salvo progettazioni particolari dopo l'esecuzione e maturazione della soletta superiore e comunque dopo che il personale di MD ITALIA s.r.l. abbia verificato la corretta chiusura delle fessurazioni programmate e il ripristino di eventuali “non conformità esecutive” della matrice in calcestruzzo.
</div>
      </div>
    </section>
  </body>
